...
export function BlogList() {
  ...
  const pageTitle = query
    ? `Resultados de buscara para "${query}"`
    ...
    <div className="flex flex-col py-24 flex-grow h-full">
      ...
      {!hasPosts && (
        <div className="container px-8">
          <div className="flex flex-col items-center justify-center gap-8 border-dashed border-2 border-gray-300 p-8 md:12 rounded-lg">
